 ...
 * - Имеет публичные generic-методы `get`, `post`, `patch`, `put`, `delete`. Возвращает Promise<XMLHttpRequest>, ответ лежит в свойстве `response`, который можно типизировать
 ...
 * - Выполняет 3 запроса в случае временной недоступности сервера или разрыва соединения, можно увеличить число попыток через опцию `tries`
 * */
